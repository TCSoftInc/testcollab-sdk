...
import {
    ...
    LoggedInUserFromJSONTyped,
    LoggedInUserToJSON,
    LoggedInUserToJSONTyped,
} from './LoggedInUser';
 ...
 */
export function instanceOfSsoToken(value: object): value is SsoToken {
...
export function SsoTokenFromJSONTyped(json: any, ignoreDiscriminator: boolean): SsoToken {
    ...
    return {
        ...
        'verifiedUser': json['verified_user'] == null ? undefined : LoggedInUserFromJSON(json['verified_user']),
    };
}
...
export function SsoTokenToJSONTyped(value?: SsoToken | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'verified_user': LoggedInUserToJSON(value['verifiedUser']),
    };
}
